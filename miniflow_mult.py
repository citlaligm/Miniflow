...
class Neuron:
    def __init__(self, inbound_neurons=[], label='',*args):
...
class Add(Neuron):
    ...
    def forward(self):
        ...
        value = 0
        for neuron in range(len(self.inbound_neurons)):
            value +=self.inbound_neurons[neuron].value
...
class Mul(Neuron):
    ...
    def forward(self):
        ...
        value = 1
        for neuron in range(len(self.inbound_neurons)):
            value = value * self.inbound_neurons[neuron].value
